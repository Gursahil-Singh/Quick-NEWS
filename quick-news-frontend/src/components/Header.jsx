...
export default function Header(props) {
  ...
  return (
    <div className='bg-slate-950 text-white min-h-12 flex justify-between md:justify-center relative items-center px-4'>
        <h1 className='cursor-default sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold tracking-wide'>
